...
**CRITICAL: Never commit sensitive data to this repository!**

This project includes built-in security protections:

- **Pre-commit hooks** automatically scan for sensitive data patterns
- **Comprehensive .gitignore** blocks common sensitive files
- **Security configuration** defines forbidden patterns and files
...
- Database credentials, cloud service keys

### Best Practices:
- Use environment variables for all secrets
- Never hardcode credentials in source code
- Test commits locally before pushing
- Review SECURITY.md for detailed guidelines

If sensitive data is accidentally committed, follow the emergency procedures in SECURITY.md immediately.
